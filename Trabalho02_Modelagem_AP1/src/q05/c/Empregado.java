...
public class Empregado {
    ...
    , double horasExtras, double salarioHoraExtra) {
        nomeEmpregado = nome;
        departamentoEmpregado = departamento;
    ...
    double calculaSalarioMensal() {
        double salario = (horasTrabalhadasNoMes * salarioPorHora) + (salarioPorHoraExtra * horasExtrasNoMes);
        if(departamentoEmpregado.contains("Diretoria")) {
